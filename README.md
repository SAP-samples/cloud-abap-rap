...
**"draftTable"**
Default value: |{ namespace }{ prefix }{ lv_entityname }{ unique_hex_number }D{ suffix }|.
**"cdsInterfaceView"**
Default value: |{ namespace }I_{ prefix }{ entityname }{ suffix }|.
**"cdsProjectionView"**
Default value: |{ namespace }C_{ prefix }{ entityname }{ suffix }|
**"metadataExtensionView"**
Default value: |{ namespace }C_{ prefix }{ entityname }{ suffix }|
**"behaviorImplementationClass"**
Default value: |{ namespace }BP_I_{ prefix }{ entityname }{ suffix }|.
**"serviceDefinition"**
|{ namespace }{ prefix }{ entityname }{ suffix }|.
**"serviceBinding"**
|{ namespace }{ binding }{ prefix }{ entityname }{ suffix }{ protocol_version }|.
**"controlStructure"**
Default value: |{ namespace }S{ prefix }{ entityname }_X{ suffix }|.
**"customQueryImplementationClass"**
Default vlaue: |{ namespace }CL_CE_{ prefix }{ entityname }{ suffix }|.
