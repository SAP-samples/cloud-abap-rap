...
define view entity ZDMO_I_RAPGENERATORBONODE
  ...
  association        to parent zDMO_I_RAPGENERATORBO as _RAPGeneratorBO on $projection.HeaderUUID = _RAPGeneratorBO.RapNodeUUID
  association [1..1] to zdmo_I_RAPGENERATORBONODE    as _Parent         on $projection.NodeUUID = _Parent.NodeUUID
  association [0..*] to zdmo_I_RAPGENERATORBONODE    as _Child          on $projection.NodeUUID = _Child.ParentUUID
{
