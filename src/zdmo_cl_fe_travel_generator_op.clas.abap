...
*      co_zlocal_package TYPE sxco_package   VALUE 'ZLOCAL'.
      co_prefix         TYPE string         VALUE 'TEST_FE_TRAVEL_',
      co_zlocal_package TYPE sxco_package   VALUE 'TEST_FE'.
...
CLASS ZDMO_CL_FE_TRAVEL_GENERATOR_OP IMPLEMENTATION.
  ...
  METHOD create_package.
    ...
    lo_specification->properties->set_super_package( co_zlocal_package ).
...
*    DATA(rap_bo_generator) = zdmo_cl_rap_generator=>create_for_cloud_development( json_string ).
     DATA(rap_bo_generator) = zdmo_cl_rap_generator=>create_for_on_prem_development( json_string ).
