CLASS zdmo_cl_rap_gen_build_json DEFINITION
  ...
  PUBLIC SECTION.
    ...
    TYPES :  tt_rapgen_node TYPE STANDARD TABLE OF ZDMO_i_rapgeneratorbonode WITH EMPTY KEY.
    TYPES :  ty_rapgen_node TYPE ZDMO_i_rapgeneratorbonode.
    TYPES :  tt_rapgen_bo TYPE STANDARD TABLE OF ZDMO_i_rapgeneratorbo WITH EMPTY KEY.
    TYPES :  ty_rapgen_bo TYPE  ZDMO_i_rapgeneratorbo.
...
*    DATA rap_bo TYPE ZDMO_rapgen_bo.
    ...
    METHODS get_child_entity_keys
      IMPORTING current_node              TYPE ZDMO_i_rapgeneratorbonode
