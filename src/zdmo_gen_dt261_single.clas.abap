CLASS zdmo_gen_dt261_single DEFINITION
...
**************************************************************************
  ...
  PRIVATE SECTION.
    ...
    CONSTANTS:
      co_prefix                     TYPE string           VALUE 'ZDT261_',
      co_entity_name                TYPE string           VALUE 'Shop',
      co_session_name               TYPE string           VALUE 'DT261',
...
CLASS zdmo_gen_dt261_single IMPLEMENTATION.
...
**        xco_runtime_exception->
    ...
    data_generator_class_name     = |zDT261_cl_vh_product_{ unique_suffix }|.
